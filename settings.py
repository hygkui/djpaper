...
DATABASES = {
    'default': {
        ...
        'USER': 'ghh',                      # Not used with sqlite3.
        'PASSWORD': 'ghhpasswd',                  # Not used with sqlite3.
...
#MEDIA_ROOT = '/home/ghh/tttt/media/'
...
STATICFILES_DIRS = (
    ...
    os.path.join(HERE , 'djpaper/static/').replace('\\','/'),
	os.path.join(HERE , 'book/static/').replace('\\','/'),
